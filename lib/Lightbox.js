	...
	_createClass(Lightbox, [{
		...
		value: function renderImages() {
			...
			return _react2.default.createElement(
				...
				this.props.renderImage ? this.props.renderImage(image, (0, _buildPropGetter2.default)({
					...
					className: function className(_className) {
						return (_className || '') + ' ' + (0, _aphrodite.css)(_this2.classes.image, imageLoaded && _this2.classes.imageLoaded);
					}
